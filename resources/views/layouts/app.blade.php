                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="{{ route('app.perfil.index') }}" class="btn btn-info btn-flat"> <i class='glyphicon glyphicon-eye-open'> </i>  Perfil</a>
                                    </div>
                                    <div class="pull-right">
                                        <a href="{{ route('login.logout') }}" class="btn btn-danger btn-flat"> <i class='glyphicon glyphicon-log-out'> </i> Sair</a>
                                    </div>
                                </li>
