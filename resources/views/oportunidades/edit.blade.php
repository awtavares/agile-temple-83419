                    ...
                    <form class="form-horizontal" method="POST" name="form" action="{{ route('app.oportunidades.update') }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
									<textarea  cols="100" rows="10" style='width: 100%;' name="descricao" placeholder="Informe a descrição da oportunidade" >  {{$oportunidade->descricao }} </textarea>
                                </div>
                            </div>
                                ...
                                <div class="col-md-2">
                                    <button type="submit" class="btn btn-block btn-success btn-flat" style="margin-left: 0%;"> Atualizar</button>
                                </div>
